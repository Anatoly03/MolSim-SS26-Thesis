...
My Family, who has been with me and always there for me, sponsored my education and gave me the opportunity to become myself.

My Friends, who gave me the energy and motivation to continue to study. I especially credit Faid Rihan, Niklas Feurstein, Anna Lena Müller, Samhitha Girish Jois, Roman Danylchuk, Kirill Tikhomirov, Kameswara Siddharth Sishta, Kacper Darowski, Lucy Yang, Ryan Xu, Melisa Aslan, Jerry Park, Patrick Dirks.
...
In 2024, Google has published a security blogpost focusing on making their software memory safe, in which they mentioned a new migration approach called ``interoperability'' which offers an incremental approach to adopting memory safety in software\cite{google-eliminating-memory-safety-vulnerabilities}. This allows working on a multi-lingual codebase where new code is written in Rust, allowing the team to define their own pace of migrating to Rust.

Already in 2020, the social platform Discord had published several blogposts explaining that they are rewritting software components in Rust with the main reasoning being performance, type safety, ecosystem and tooling\cite{discord-moves-to-rust}.

...
This section aims to provide some understanding on how Rust determines which function is executed when a type implements multiple traits that share a common method identifier. Consider the following example.

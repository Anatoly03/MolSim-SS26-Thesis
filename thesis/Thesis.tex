...
\begin{tikzpicture}
    \begin{axis}[
        ...
        % xmin=-5,
        x tick label style={/pgf/number format/.cd, 1000 sep={}},
        legend style={at={(0.39,0.98)},anchor=north west},
    ]
    ...
    \legend{C++ [DirectSum-Parallel], Rust [DirectSum-Parallel]}
    \end{axis}
\end{tikzpicture}
...
The thread count was set with environment variables \texttt{RAYON\_NUM\_THREADS} and \texttt{OMP\_NUM\_THREADS}.

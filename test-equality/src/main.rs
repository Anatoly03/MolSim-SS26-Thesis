...
fn main() {
    ...
    #[cfg(feature = "full")]
    {
        cpp::bench("two-bodies-collision-0001", 0.0007, 10);
        rust::bench("two-bodies-collision-0001", 0.0007, 10);
    }
    ...
    #[cfg(feature = "full")]
    {
        cpp::bench("two-bodies-collision-0001", 0.0007, 30);
        rust::bench("two-bodies-collision-0001", 0.0007, 30);
    }

    #[cfg(feature = "full")]
    {
        cpp::bench("two-bodies-collision-0001", 0.0007, 40);
        rust::bench("two-bodies-collision-0001", 0.0007, 40);
    }
    ...
    #[cfg(feature = "full")]
    {
        cpp::bench("two-bodies-collision-0001-linked-cells", 0.0007, 10);
        rust::bench("two-bodies-collision-0001-linked-cells", 0.0007, 10);
    }
    ...
    #[cfg(feature = "full")]
    {
        cpp::bench("two-bodies-collision-0001-linked-cells", 0.0007, 30);
        rust::bench("two-bodies-collision-0001-linked-cells", 0.0007, 30);

        cpp::bench("two-bodies-collision-0001-linked-cells", 0.0007, 40);
        rust::bench("two-bodies-collision-0001-linked-cells", 0.0007, 40);
    }
    ...
    #[cfg(feature = "full")]
    {
        cpp::bench("two-bodies-collision-0001-parallel", 0.0007, 10);
        rust::bench("two-bodies-collision-0001-parallel", 0.0007, 10);
    }
    ...
    #[cfg(feature = "full")]
    {
        cpp::bench("two-bodies-collision-0001-parallel", 0.0007, 30);
        rust::bench("two-bodies-collision-0001-parallel", 0.0007, 30);

        cpp::bench("two-bodies-collision-0001-parallel", 0.0007, 40);
        rust::bench("two-bodies-collision-0001-parallel", 0.0007, 40);
    }
